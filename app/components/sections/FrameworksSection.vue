<template>
  <section id="frameworks" class="bg-brand-mint-pale py-16 md:py-24 scroll-mt-20">
    <div class="max-w-[1000px] mx-auto px-6">
      
      <!-- Section Header -->
      <div class="text-center max-w-[640px] mx-auto mb-16">
        <h2 class="font-serif text-[28px] md:text-[40px] leading-[1.2] text-brand-navy-deep mb-4">
          Frameworks we cover
        </h2>
        <p class="font-sans text-[18px] leading-[1.6] text-brand-grey-400">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-white border border-brand-border rounded-lg p-6 flex flex-col sm:flex-row gap-6 items-start hover:-translate-y-1 transition-transform duration-300">
          ...
          <div>
            <h3 class="font-sans font-semibold text-[20px] text-brand-navy-deep mb-2 mt-[-3px]">ISO 27001</h3>
        ...
        <div class="bg-white border border-brand-border rounded-lg p-6 flex flex-col sm:flex-row gap-6 items-start hover:-translate-y-1 transition-transform duration-300">
          ...
          <div>
            <h3 class="font-sans font-semibold text-[20px] text-brand-navy-deep mb-2 mt-[-3px]">UK & EU GDPR</h3>
            <p class="font-sans text-[15px] leading-[1.6] text-brand-grey-700">
      ...
      <div class="flex justify-center">
        <div class="w-full md:w-[calc(50%-12px)] bg-white border border-brand-border rounded-lg p-6 flex flex-col sm:flex-row gap-6 items-start opacity-80 hover:opacity-100 transition-opacity duration-300">
          <div class="flex-shrink-0">
            <span class="inline-block px-3 py-1 bg-brand-grey-50 text-brand-grey-400 text-[13px] font-sans font-medium rounded-full whitespace-nowrap">Coming soon</span>
          </div>
          <div>
